...
We learn more about contact tracing for COVID-19 every day. This playbook collects what we've learned from various government, policy, and public health communities about scaling contact tracing programs. We link to resources, frameworks, and templates to help you consider how to implement basic contact tracing in your community. Note that high-risk communities \(e.g., correctional, healthcare, or long-term care\) may require additional support beyond the scope of what we cover here.
